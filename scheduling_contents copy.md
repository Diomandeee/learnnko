...
export function NewCoffeeShopForm() {
  ...
  const [owners, setOwners] = useState<OwnerInput[]>([{ name: '', email: '' }])
...
// Update owner field
const updateOwner = (index: number, field: keyof OwnerInput, value: string) => {
                ...
                <div className="space-y-4">
                  ...
                  {owners.map((owner, index) => (
                    <div key={index} className="space-y-4 p-4 border rounded-lg">
                      <div className="flex items-center justify-between">
                        <h4 className="text-sm font-medium">Owner {index + 1}</h4>
                        {owners.length > 1 && (
                          <Button
                            type="button"
                            variant="ghost"
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Textarea 
                          placeholder="Add any notes about the coffee shop..."
