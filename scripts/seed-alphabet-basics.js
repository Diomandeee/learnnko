// Run this with: node seed-alphabet-basics.js
...
async function seedLesson() {
  try {
    const mongoId = getMongoDatabaseId(alphabetBasicsLesson.id);
    console.log(`MongoDB ID for ${alphabetBasicsLesson.id}: ${mongoId}`);
